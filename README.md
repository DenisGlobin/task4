...
Веб роут *'/'* либо *'/documents/page=1&perPage=10'*. API роуты указаны ниже по тексту.
...
**[Мой отчёт по затраченному времени](https://github.com/DenisGlobin/task4/blob/master/TaskListReport.md)**
